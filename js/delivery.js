document.addEventListener("DOMContentLoaded", () => {
  ...
  // Handle Mark Delivered button click
  tableBody.addEventListener("click", (e) => {
    if (e.target.classList.contains("deliver-btn")) {
      ...
      row.querySelector("td:nth-child(5)").classList.add("delivered");

      e.target.disabled = true;
      e.target.textContent = "Delivered";
      showPopup(`Order #${row.children[0].textContent} marked as delivered`, "success");
    }
  });
